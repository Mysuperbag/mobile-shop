<template>
  <div id="profile">
    <nav-bar class="nav-bar">
      <template v-slot:center>谷粒商城</template>
    </nav-bar>
    <user-info/>
...
<script>
import UserInfo from "@/views/modules/profile/user-info";
import ListView from "@/views/modules/profile/list-view";

export default {
  name: "profile",
  components: {ListView, UserInfo},
  data: function () {
    return {
      orderList: [
      ...
      serviceList: [
        {icon: '#res-well', iconColor: '#ff8198', info: '我的购物车'},
